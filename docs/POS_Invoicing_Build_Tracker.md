...
_Last updated: May 6, 2026 | Module: Invoicing (1st) | Target: August 2026_
...
| 5   | Outgoing PDF missing/unopenable for one same-org recipient (post-[078](decisions/078-invoice-email-pdf-mime.md) MIME harden) | ✓ Resolved (2026-07-27) — recipient received the PDF; first real-client send confirmed ([185](decisions/185-invoice-pdf-received-resolved.md)). Diagnostics runbook retained for any future asymmetry. |
...
7. **Smoke test:** use **Download PDF** and **Send test to myself** on a draft invoice, then send to a real client address. **Owner:** first real-client send + PDF receipt confirmed **2026-07-27** ([185](decisions/185-invoice-pdf-received-resolved.md)).
...
**Same-org PDF asymmetry:** Jul 2026 incident closed — recipient received PDF ([185](decisions/185-invoice-pdf-received-resolved.md)). If asymmetry returns, do not guess MIME — follow [`docs/invoice-pdf-email-diagnostics.md`](invoice-pdf-email-diagnostics.md) ([083](decisions/083-invoice-pdf-email-diagnostics.md)).
