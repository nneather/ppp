...
**Active module (2026-07-24):** [POS_Classwork_Build_Tracker.md](POS_Classwork_Build_Tracker.md) — **Session 1** (schema + `/classwork` CRUD). Session 0 done ([150](decisions/150-classwork-session-0.md)). Contacts/CRM Session 0 queued next ([139](decisions/139-lightweight-crm-fall-priority.md)).
