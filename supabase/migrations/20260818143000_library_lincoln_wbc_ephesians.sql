-- library_lincoln_wbc_ephesians: Andrew T. Lincoln, Ephesians, WBC 42 (1990)
-- Owner confirm 2026-08-18: 1A Word/Waco sibling imprint, 2 clean.
...
FROM (VALUES
	('Ephesians', 'Word', 'Waco, TX', 1990, NULL::int, '9780849902413', '42', 'WBC')
...
JOIN public.publishers pub ON pub.canonical_name = v.publisher AND pub.deleted_at IS NULL
WHERE NOT EXISTS (
...
FROM (VALUES
	('Ephesians', 'WBC', 'Andrew', 'T', 'Lincoln', 0)
