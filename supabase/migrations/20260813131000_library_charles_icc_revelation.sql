-- library_charles_icc_revelation: R. H. Charles ICC Revelation 2-vol shelf add.
-- Owner confirm 2026-08-13: ISBN null (1920 originals), split titles, Robert H. Charles.
...
FROM (VALUES
	('Revelation 1–14', 'ICC', 'Robert', 'H.', 'Charles', 0),
	('Revelation 15–22', 'ICC', 'Robert', 'H.', 'Charles', 0)
...
FROM (VALUES
	('Revelation 1–14', 'ICC', 'Revelation'),
	('Revelation 15–22', 'ICC', 'Revelation')
