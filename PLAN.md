...
**Repo gate:** Sports ESPN date-range 400 [228](docs/decisions/228-sports-espn-scoreboard-date-range.md) — `npm run check` **0 errors / 0 warnings**; `npm run test` **553/553** (2026-09-16). Live ESPN per-day fetch: NFL 1 / MLB 39 / CFB 311. Needs a push to `main` before the next 10m cron.
