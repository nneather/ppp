...
**Repo gate:** `npm run check` + `npm run test` **2026-07-24** ([142](docs/decisions/142-series-include-in-citation.md); **0 errors**, 319 tests). Prior: [140](docs/decisions/140-library-search-prefix-tsquery.md).
