...
**Last updated:** 2026-08-18 — Lincoln WBC Ephesians vol 42 ([203](docs/decisions/203-library-lincoln-wbc-ephesians.md)); prior invoice list mark-paid ([202](docs/decisions/202-invoicing-list-mark-paid.md)).
...
**Repo gate:** Invoice list mark-paid + undo [202](docs/decisions/202-invoicing-list-mark-paid.md) — `npm run check` **0 errors**, `npm run test` **457** passed (2026-08-17).
