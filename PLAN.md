...
**Last updated:** 2026-08-17 — Invoice list one-tap mark-paid + undo ([202](docs/decisions/202-invoicing-list-mark-paid.md)); prior analytics range + one-offs ([201](docs/decisions/201-invoicing-analytics-range-one-offs.md)).
