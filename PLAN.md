...
**Last updated:** 2026-07-23 — Sermons by-book series/dedupe/latest date ([134](docs/decisions/134-sermons-by-book-series-dedupe.md)); Baker publisher pass ([133](docs/decisions/133-baker-publisher-link-pass.md)); desktop home dashboard ([132](docs/decisions/132-desktop-home-dashboard.md)).
...
**Repo gate:** `npm run check` + `npm run test` **2026-07-23** ([134](docs/decisions/134-sermons-by-book-series-dedupe.md); **0 errors**, 303 tests). Prior: [132](docs/decisions/132-desktop-home-dashboard.md).
