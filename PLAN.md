...
**Last updated:** 2026-07-23 — Calvin CC imprint normalize ([122](docs/decisions/122-calvin-cc-imprint-normalize.md)); commentary Batch 5 ([121](docs/decisions/121-commentary-consistency-batch5.md)).
...
**Library — Wave 2 Sessions 1–4 complete; August shelf QA:** Trip QA **signed off 2026-06-03** ([043](docs/decisions/043-library-trip-qa-signoff-projects-handoff.md)). **Fixture-first build** locked 2026-07-06 ([056](docs/decisions/056-library-wave2-phase0.md)). **Track A (Covenant strings) done** ([102](docs/decisions/102-august-qa-covenant-fixtures.md)). **Track B** (physical shelf of all 20 rows) still open. **Owner smokes left:** essays/ABD + Articles search; PWA resume re-smoke. **`.docx` Word smoke ✅** ([063](docs/decisions/063-library-wave2-session4-docx-export.md)); commentary series ([113](docs/decisions/113-commentary-series-volume-omit.md)); cite strip ([114](docs/decisions/114-book-detail-ui-cleanup.md)); postal locations ([115](docs/decisions/115-publisher-location-postal.md)).
...
- [121 — Commentary consistency Batch 5](docs/decisions/121-commentary-consistency-batch5.md) (2026-07-23) — Calvin 22-vol map; Spurgeon off SS; EGGNT B&H fixes; Wright UBCS soft-delete; August shelf flags.
- [120 — Commentary consistency Batch 4](docs/decisions/120-commentary-consistency-batch4.md) (2026-07-22) — Jobes BECNT 2nd ed; EGGNT Kruse/Harris imprint fixes; B&H string normalize.
...
**Repo gate:** `npm run check` **2026-07-22** ([118](docs/decisions/118-book-detail-cite-card-spacing.md); **0 errors**). Prior: [115](docs/decisions/115-publisher-location-postal.md) check+test.
...
### Do now
1. **Owner smokes (remaining)** — essays/ABD + Articles-in-volumes search ([086](docs/decisions/086-essay-visibility-and-search-lanes.md)); **re-smoke PWA resume auto-update** after [111](docs/decisions/111-pwa-resume-auto-apply-harden.md); optional library megacomponent phone pass ([062](docs/decisions/062-library-wave2-session3-megacomponent-split.md), `.claude/skills/library-owner-smoke/`); glance Actions after next Monday weekly backup ([079](docs/decisions/079-ops-hardening-backups-restore-revoke.md)).
...
- **Owner smoke (2026-07-22)** — sermons list + by-book ✅ ([110](docs/decisions/110-sermons-owner-smoke-ux.md)); Projects E2E ✅ ([112](docs/decisions/112-task-sheet-date-overflow.md)); Fountain of Life archived ✅ ([064](docs/decisions/064-usage-retrospective-review.md) Q4); **`.docx` Word ✅** + commentary series ([113](docs/decisions/113-commentary-series-volume-omit.md)); writing-session copy / cite strip ✅ ([094](docs/decisions/094-library-writing-session-gaps.md), [114](docs/decisions/114-book-detail-ui-cleanup.md), [115](docs/decisions/115-publisher-location-postal.md)); commentary consistency Batches 1–5 ✅ ([116](docs/decisions/116-commentary-consistency-batch1.md)–[121](docs/decisions/121-commentary-consistency-batch5.md)); PWA boot shell + toast OK — **resume re-smoke still open** ([111](docs/decisions/111-pwa-resume-auto-apply-harden.md)).
