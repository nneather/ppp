...
**Last updated:** 2026-07-22 — Book detail cite card + denser facts ([118](docs/decisions/118-book-detail-cite-card-spacing.md)); prior: postal locations ([115](docs/decisions/115-publisher-location-postal.md)), cite strip ([114](docs/decisions/114-book-detail-ui-cleanup.md)); owner-smoke list (copy row ✅; essays + PWA resume re-smoke open).
...
- [118 — Book detail cite card + denser facts](docs/decisions/118-book-detail-cite-card-spacing.md) (2026-07-22) — restored Cite card; tighter fact rows; fixed-width status sidebar.
...
- **Owner smoke (2026-07-22)** — sermons list + by-book ✅ ([110](docs/decisions/110-sermons-owner-smoke-ux.md)); Projects E2E ✅ ([112](docs/decisions/112-task-sheet-date-overflow.md)); Fountain of Life archived ✅ ([064](docs/decisions/064-usage-retrospective-review.md) Q4); **`.docx` Word ✅** + commentary series ([113](docs/decisions/113-commentary-series-volume-omit.md)); writing-session copy / cite strip ✅ ([094](docs/decisions/094-library-writing-session-gaps.md), [114](docs/decisions/114-book-detail-ui-cleanup.md), [115](docs/decisions/115-publisher-location-postal.md)); PWA boot shell + toast OK — **resume re-smoke still open** ([111](docs/decisions/111-pwa-resume-auto-apply-harden.md)).
