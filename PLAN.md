...
**Last updated:** 2026-09-10 — Contacts couple last-name backfill ([226](docs/decisions/226-contacts-couple-last-name-backfill.md)); A–Z jump duplicate keys ([225](docs/decisions/225-contacts-az-jump-duplicate-keys.md)).
...
**Repo gate:** Contacts last-name backfill [226](docs/decisions/226-contacts-couple-last-name-backfill.md) — `npm run check` **0 errors / 0 warnings**; sheet-import + sort tests pass; hosted names patched (2026-09-10).
