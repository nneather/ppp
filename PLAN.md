...
**Last updated:** 2026-07-23 — Desktop home dashboard ([132](docs/decisions/132-desktop-home-dashboard.md)); B&H publisher link ([131](docs/decisions/131-bh-publisher-link-backfill.md)); Email Inbox → Personal ([130](docs/decisions/130-retire-email-inbox-default-personal.md)).
...
**Repo gate:** `npm run check` + `npm run test` **2026-07-23** ([132](docs/decisions/132-desktop-home-dashboard.md); **0 errors**, 299 tests). Prior: [131](docs/decisions/131-bh-publisher-link-backfill.md).
