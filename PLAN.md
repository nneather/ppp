...
**Last updated:** 2026-09-10 — Sports sync via GitHub Actions ([220](docs/decisions/220-sports-sync-github-actions.md)); prior library Sep 9 shelf batch ([219](docs/decisions/219-library-sep9-shelf-batch.md)).
...
| Sports | [docs/POS_Sports_Build_Tracker.md](docs/POS_Sports_Build_Tracker.md) | ✅ Session 1 scoreboard + **GHA ESPN sync** every 10m ([220](docs/decisions/220-sports-sync-github-actions.md)). Hobby Vercel cron is backup only. |
...
**Sports:** `/sports` scoreboard + follow stars + owner Refresh; dashboard glance; GHA `.github/workflows/sports-sync.yml` every 10m (`npm run sports:sync`); Vercel daily cron is Hobby backup only. Helpers `src/lib/sports/`; migration `20260902221000_ppp_sports_v1.sql` ([218](docs/decisions/218-sports-session-1.md), [220](docs/decisions/220-sports-sync-github-actions.md)).
...
**Repo gate:** Sports GHA sync [220](docs/decisions/220-sports-sync-github-actions.md) — `npm run check` **0 errors**, `npm run test` **530** passed (2026-09-10).
