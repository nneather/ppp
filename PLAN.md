...
**Last updated:** 2026-07-22 — Book detail UI cleanup ([114](docs/decisions/114-book-detail-ui-cleanup.md)); prior: commentary series omit `Vol. N.` ([113](docs/decisions/113-commentary-series-volume-omit.md)), `.docx` smoke, owner-smoke wrap ([110](docs/decisions/110-sermons-owner-smoke-ux.md)–[112](docs/decisions/112-task-sheet-date-overflow.md)).
...
**Repo gate:** `npm run check` **2026-07-22** ([114](docs/decisions/114-book-detail-ui-cleanup.md); **0 errors**). Prior test: [113](docs/decisions/113-commentary-series-volume-omit.md) format.test.ts.
