...
**Last updated:** 2026-07-23 — Library Bible coverage list filter ([123](docs/decisions/123-library-bible-coverage-filter.md)); Calvin CC imprint normalize ([122](docs/decisions/122-calvin-cc-imprint-normalize.md)); commentary Batch 5 ([121](docs/decisions/121-commentary-consistency-batch5.md)).
