...
**Last updated:** 2026-07-23 — Baker/Baker Academic publisher pass ([133](docs/decisions/133-baker-publisher-link-pass.md)); desktop home dashboard ([132](docs/decisions/132-desktop-home-dashboard.md)); B&H link ([131](docs/decisions/131-bh-publisher-link-backfill.md)).
...
- [133 — Baker / Baker Academic publisher link pass](docs/decisions/133-baker-publisher-link-pass.md) (2026-07-23) — Praying with Paul + stragglers; BECNT/Beale → Academic; ZECNT Ephesians → Zondervan; NIBC Psalms → Hendrickson; Brazos Litfin.
