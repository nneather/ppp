...
**Sports:** `/sports` scoreboard + follow stars; dashboard glance; cron `GET /api/sports/sync` (`CRON_SECRET`); helpers `src/lib/sports/`; migration `20260902221000_ppp_sports_v1.sql` ([218](docs/decisions/218-sports-session-1.md)).
