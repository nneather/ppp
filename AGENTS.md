...
- **Sports helpers** at `src/lib/sports/` (schema migration `20260902221000_ppp_sports_v1.sql`; Session 1 [218](docs/decisions/218-sports-session-1.md)):
  ...
  - CLI / GHA: `npm run sports:sync` (`--standings` for teams+records); `.github/workflows/sports-sync.yml` every 10m (`npx tsx`, no `npm ci` — script must not import `dotenv` or other packages — [227](docs/decisions/227-sports-sync-gha-dotenv.md), CFB beyond FBS [221](docs/decisions/221-sports-cfb-beyond-fbs.md)).
